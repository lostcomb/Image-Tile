...
var Group = (function () {
  ...
  Group.prototype.isTopMost = function (tile) {
    var cond = function (tile, test_tile) {
      var withinX = test_tile.getX() > (tile.getX() - tile.getWidth() / 2)
                 && test_tile.getX() < (tile.getX() + tile.getWidth() / 2);
      var withinY = (test_tile.getY() + test_tile.getHeight()) > (tile.getY() - tile.getHeight() / 2)
  ...
  Group.prototype.isRightMost = function (tile) {
    var cond = function (tile, test_tile) {
      ...
      var withinY = test_tile.getY() > (tile.getY() - tile.getHeight() / 2)
  ...
  Group.prototype.isLeftMost = function (tile) {
    var cond = function (tile, test_tile) {
      var withinX = (test_tile.getX() + test_tile.getWidth()) > (tile.getX() - tile.getWidth() / 2)
