...
module.exports = (function () {
  ...
  ImageData.prototype.setImageRotation = function (rotation) {
    ...
    attrs.get(this).cond = Math.floor(
      Math.abs(attrs.get(this).rotation) / (Math.PI / 2)
    ) % 2 == 0;
  };
  ...
  ImageData.prototype.getScale = function () {
    var w = (attrs.get(this).ABS_COS * attrs.get(this).view_area.getWidth())
          + (attrs.get(this).ABS_SIN * attrs.get(this).view_area.getHeight());
    var h = (attrs.get(this).ABS_SIN * attrs.get(this).view_area.getWidth())
    ...
    if (attrs.get(this).image_fit == ImageFit.CROP)
      scale /= attrs.get(this).crop_scale;
  ...
  ImageData.prototype.getPosOffset = function (scale) {
    ...
    var width  = attrs.get(this).cond ? attrs.get(this).view_area.getWidth()
                                      : attrs.get(this).view_area.getHeight();
    var height = attrs.get(this).cond ? attrs.get(this).view_area.getHeight()
    ...
    if (attrs.get(this).cond)
      var offset_x = (sw - bw) / 2, offset_y = (sh - bh) / 2;
    else
      var offset_x = (sh - bh) / 2, offset_y = (sw - bw) / 2;
