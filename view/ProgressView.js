...
module.exports = (function() {
    ...
    function ProgressView(id) {
        ...
        attrs.get(this).element.addEventListener("transitionend", function() {
            while (element.classList.contains("anim")) element.classList.remove("anim");
            while (element.classList.contains("full")) element.classList.remove("full");
        });
    }
    ...
    ProgressView.prototype.start = function() {
        while (attrs.get(this).element.classList.contains("full")) attrs.get(this).element.classList.remove("full");
